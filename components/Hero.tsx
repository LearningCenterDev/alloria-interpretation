            ...
            <div className="max-w-7xl mx-auto w-full relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    >
                        ...
                        >
                            Certified human interpretation for medical, legal, and business needs. Delivering precision <span className="text-slate-900 font-bold">where communication feels like play.</span>
                        </motion.p>
                        ...
                        >
                            {["Instant Connect", "Expert Linguists", "HIPAA Protected"].map((feat) => (
                        ...
                        >
                            <motion.button
                                whileHover={{ scale: 1.05, y: -2, boxShadow: "0 20px 40px -10px rgba(47, 191, 113, 0.4)" }}
                                whileTap={{ scale: 0.95 }}
                            ...
                            <motion.button
                                whileHover={{ scale: 1.05, backgroundColor: "rgb(248 250 252)", y: -2 }}
                                whileTap={{ scale: 0.95 }}
                            ...
                            >
                                How it works <ArrowRight size={18} className="transition-transform group-hover:translate-x-1" />
                            </motion.button>
                        </motion.div>
                        ...
                        >
                            <div className="flex -space-x-3">
                                {[1, 2, 3, 4].map(i => (
                                    <div key={i} className="w-9 h-9 rounded-full border-[3px] border-white overflow-hidden bg-slate-200 shadow-sm transition-transform hover:scale-110 hover:z-10">
                                        <Image src={`https://i.pravatar.cc/100?img=${i + 11}`} width={36} height={36} alt="User" />
                                    </div>
                                ))}
                            </div>
                            <div className="flex flex-col border-l border-slate-200/60 pl-5">
                                <span className="text-[10px] font-black uppercase text-slate-400 tracking-[0.15em] leading-none mb-1">Our Community</span>
                                <div className="flex items-center gap-2">
                                    <div className="flex text-yellow-500">
                                        {[1, 2, 3, 4, 5].map(s => <Star key={s} size={11} fill="currentColor" />)}
                                    </div>
                                    <span className="text-[12px] font-black text-slate-900">4.9/5 Rating</span>
                                </div>
                            </div>
                        </motion.div>
                    </motion.div>
                    ...
                    <div className="relative mt-12 lg:mt-0 flex justify-center lg:justify-end">
                        ...
                        >
                            ...
                            >
                                ...
                                <div>
                                    <p className="text-[10px] font-black text-slate-800 uppercase tracking-tight">Live Video Call</p>
                                    <div className="flex gap-1 items-center mt-0.5">
                                        <div className="w-1.5 h-1.5 bg-brand-primary rounded-full animate-pulse" />
                                        <p className="text-[9px] font-black text-brand-primary uppercase">Active Now</p>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            >
                                ...
                                <div>
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Global Support</p>
                                    <p className="text-[13px] font-black text-slate-900 tracking-tight">30+ LANGUAGES</p>
                                </div>
                            </motion.div>
                        </motion.div>
                    </div>
