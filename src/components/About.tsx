                    ...
                    <div className="relative z-10 grid lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-16 items-center">
                        <div>
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <motion.h2
                                    ...
                                    viewport={{ once: true }}
                                    className="text-brand-accent font-black uppercase text-[10px] tracking-[0.4em]"
                                >
                            ...
                            >
                                Speed Meets <span className="text-brand-accent italic">Precision</span>
                            </motion.h3>
                            <motion.p
                                initial={{ opacity: 0, x: -20 }}
                                whileInView={{ opacity: 1, x: 0 }}
                            ...
                            >
                                <div className="px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-[10px] font-black uppercase tracking-widest text-slate-300 flex items-center gap-2 hover:bg-white/10 transition-colors">
                                    <ShieldCheck size={14} className="text-brand-accent" /> HIPAA Compliant
                                </div>
                                <div className="px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-[10px] font-black uppercase tracking-widest text-slate-300 flex items-center gap-2 hover:bg-white/10 transition-colors">
                                    <CheckCircle size={14} className="text-brand-accent" /> ISO 9001
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {stats.map((stat, index) => (
                                ...
                                >
                                    <div className="w-9 h-9 bg-brand-accent/10 rounded-lg flex items-center justify-center text-brand-accent mb-3 transition-transform group-hover:scale-110">
                                        {stat.icon}
                                    </div>
